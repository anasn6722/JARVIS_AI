...
class Brain:
    ...
    def process(self, command: str) -> str:
        ...
        # =========================================================
        # ONE PIPELINE FOR THE ENTIRE USER REQUEST
        # =========================================================
        #
        # CommandStage is responsible for:
        #
        #   command splitting
        #   command parsing
        #   agent routing
        #
        # PlanningStage is responsible for:
        #
        #   task creation
        ...
        #
        # Keeping one PipelineContext is essential because all
        # commands must share the same workflow graph.
        # =========================================================
